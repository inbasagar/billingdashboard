...
const Paginationarrivals_tnagar = (props) => {
          ...
          {page > 1 && (
            <li className="page-item">
              <Link
                ...
                to={
                  keyword
                    ? `/search/${keyword}/pagearrivalst/${page - 1}`
                    : `/pagearrivalst/${page - 1}`
                }
              >
                Previous
              </Link>
            ...
            return (
              ...
              >
                <Link
                  ...
                  to={
                    keyword
                      ? `/search/${keyword}/pagearrivalst/${pageNumber}`
                      : `/pagearrivalst/${pageNumber}`
                  }
                >
                  {pageNumber}
                </Link>
...
export default Paginationarrivals_tnagar;
