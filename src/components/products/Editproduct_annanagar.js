...
import { editProductannanagar, updateProductannanagar } from "../../Redux/Actions/ProductActionsanna";
...
const EditProductMain_annanagar = (props) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      if (!product.name || product._id !== productId) {
        dispatch(editProductannanagar(productId));
      } else {
...
export default EditProductMain_annanagar;
