...
import PaginationOrder_tnagar from "./paginationorder_tnagar";


const NewOrderMain_tnagar = (props) => {
  ...
  useEffect(() => {
    dispatch(listorderedProductstnagar(keyword,pagenumber));
...
export default NewOrderMain_tnagar;
/*          <nav className="float-end mt-4" aria-label="Page navigation">
 //                     {/* Pagination */
   //                   <Pagination
     //             pages={pages}
