...
import Pagination_annanagar from "./pagination_annanagar";

const MainProducts_annagar = (props) => {
  ...
  const submitHandler = (e) => {
    ...
    //  history.push(`/search/${keyword}`);
      history.push(`/productsanna/${keyword}`);
    } else {
      history.push("/");
    }
  };
  useEffect(() => {
    dispatch(listProductsannanagar(keyword,pagenumber));
          ...
          {loading ? (
            ...
            <div className="row">
                ...
                {products.map((product) => (
                    ...
                    <Product_annanagar product={product} key={product._id} />
...
export default MainProducts_annagar;
/*          <nav className="float-end mt-4" aria-label="Page navigation">
 //                     {/* Pagination */
   //                   <Pagination
     //             pages={pages}
