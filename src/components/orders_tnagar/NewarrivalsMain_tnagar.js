...
import { listNewarrivalstnagar, listProductstnagar } from "../../Redux/Actions/ProductActionst";
import Pagination_tnagar from "../products/paginationt";
import Newarrivals_tnagar from "./Newarrivals_tnagar";
import Paginationarrivals_tnagar from "../products/paginationarrivalst";
const MainProducts_tnagar = (props) => {
  ...
  const { loading, error, products, page, pages } = newarrivals;
  ...
  useEffect(() => {
    dispatch(listNewarrivalstnagar(keyword,pagenumber));
          ...
          {loading ? (
            ...
            <Message variant="alert-danger">{error}</Message>
                        ...
                        {products
                          ...
                          .map((product) => (
                            <Newarrivals_tnagar product={product} key={product._id}>
