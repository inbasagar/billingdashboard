...
import {
  deliverOrder,
  getOrderDetails,
  getOrderDetails_annanagar,
  paidOrder,
  
} from "../../Redux/Actions/OrderActions_annanagar";
import Loading from "../LoadingError/Loading";
import Message from "../LoadingError/Error";
import moment from "moment";
import OrderDetailInfo_annanagar from "./OrderDetailInfo_annanagar";
import OrderDetailProducts_annanagar from "./OrderDetailProducts_annanagar";

const OrderDetailmain_annanagar = (props) => {
...
//Create your invoice! Easy!
  ...
  useEffect(() => {
    dispatch(getOrderDetails_annanagar(orderId));
      ...
      {loading ? (
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <OrderDetailInfo_annanagar order={order} />

            <div className="row">
              <div className="col-lg-12">
                <div className="table-responsive">
                  <OrderDetailProducts_annanagar order={order} loading={loading} />
                </div>
              </div>
...
export default OrderDetailmain_annanagar;
