...
export const listProducts = (keyword = " ",pageNumber=" ") => async (dispatch, getState) => {
  try {
    ...
    const { data } = await Axios.get(`/api/products?pageNumber=${pageNumber}&keyword=${keyword}`, config);
...
export const listProductstnagar = (keyword = " ",pageNumber=" ") => async (dispatch, getState) => {
  try {
    ...
    const { data } = await Axios.get(`/api/products/tnagar`, config);
//?pageNumber=${pageNumber}
    dispatch({ type: PRODUCT_LIST_SUCCESS, payload: data });
  } catch (error) {
    const message =
...
export const listProductsannanagar = (keyword = " ",pageNumber=" ") => async (dispatch, getState) => {
  try {
    ...
    const { data } = await Axios.get(`/api/products/annanagar`, config);
//?pageNumber=${pageNumber}
    dispatch({ type: PRODUCT_LIST_SUCCESS, payload: data });
  } catch (error) {
    const message =
