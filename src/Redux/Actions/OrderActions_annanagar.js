...
import { updateProductCountsannanagar } from "./ProductActionsanna.js";
  ...
  const editProduct = async (productId) => {
    try {
      ...
      const { data } = await Axios.get(`/api/productsanna/${productId}`);
  ...
  */}
  ...
  export const createOrder = (order) => async (dispatch, getState) => {
    ...
    const { data } = await Axios.post(`/api/ordersanna`, order, config);
      ...
      for (const orderItem of order.orderItems) {
        ...
        const { product,qty} = orderItem;
          ...
          const { data } = await Axios.get(`/api/productsanna/${orderItem.product}`);
  ...
  export const createOrder_annanagar = (order) => async (dispatch, getState) => {
    try {
      dispatch({ type: ORDER_CREATE_REQUEST });
  ...
  */}
  export const listOrders_annanagar = (keyword = " ") => async (dispatch, getState) => {
    try {
      ...
      const { data } = await Axios.get(`/api/ordersanna/all?keyword=${keyword}`, config);
  ...
  */
  ...
  export const getOrderDetails = (id) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await Axios.get(`/api/orderanna/${id}`, config);
  ...
  export const getOrderDetails_annanagar = (id) => async (dispatch, getState) => {
    try {
      dispatch({ type: ORDER_DETAILS_REQUEST });
      ...
      const { data } = await Axios.get(`/api/ordersanna/${id}`, config);
      dispatch({ type: ORDER_DETAILS_SUCCESS, payload: data });
    } catch (error) {
      const message =
        error.response && error.response.data.message
  ...
  export const deliverOrder = (order) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await Axios.put(
        `/api/ordersanna/${order._id}/delivered`,
        {},
        config
      );
  ...
  export const markItemAsDelivered = (orderId, itemId) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await Axios.put(
        `/api/ordersanna/${orderId}/isproductdelivered`, // Corrected URL with orderId only
  ...
  export const markItemAstobetaken = (orderId, itemId) => async (dispatch, getState) => {
    try {
      ...
      // Perform the API call to mark the item as delivered (you may need to implement this API endpoint)
      const { data } = await Axios.put(
        `/api/ordersanna/${orderId}/isproducttobetaken`, // Corrected URL with orderId only
  ...
  export const markItemAsundelievered = (orderId, itemId) => async (dispatch, getState) => {
    try {
      ...
      // Perform the API call to mark the item as delivered (you may need to implement this API endpoint)
      const { data } = await Axios.put(
        `/api/ordersanna/${orderId}/isproductundelivered`, // Corrected URL with orderId only
  ...
  export const markItemAsPaid= (orderId, itemId) => async (dispatch, getState) => {
    try {
      ...
      // Perform the API call to mark the item as delivered (you may need to implement this API endpoint)
      const { data } = await Axios.put(
        `/api/ordersanna/${orderId}/isproductpaid`, // Corrected URL with orderId only
