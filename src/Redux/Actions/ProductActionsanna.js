...
export const listProductsannanagar = (keyword = " ",pageNumber=" ") => async (dispatch, getState) => {
    try {
      ...
      const { data } = await Axios.get(`/api/productsanna?pageNumber=${pageNumber}&keyword=${keyword}`, config);
  ...
  */
  // DELETE PRODUCT
  export const deleteProductannanagar = (id) => async (dispatch, getState) => {
    try {
      ...
      await Axios.delete(`/api/productsanna/${id}`, config);
  ...
  // CREATE PRODUCT
  export const createProductannanagar =
  ...
  // EDIT PRODUCT
  export const editProductannanagar = (id) => async (dispatch) => {
    try {
  ...
  export const updateProductCountsannanagar = (
    productId,
    name,
    price,
    description,
  ...
  */}
  // UPDATE PRODUCT
  export const updateProductannanagar = (product) => async (dispatch, getState) => {
    try {
      dispatch({ type: PRODUCT_UPDATE_REQUEST });
  ...
  export const listProductDetailsannanagar = (id) => async (dispatch) => {
    try {
